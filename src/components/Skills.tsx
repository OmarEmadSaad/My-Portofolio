...
import { Code, Layout, Palette, PenTool as Tool, CodeSquare } from 'lucide-react';
...
const Skills = () => {
  ...
  const categories = [
    ...
    { id: 'core', label: t('skills.categories.core'), icon: <Code size={20} /> },
    { id: 'frameworks', label: t('skills.categories.frameworks'), icon: <Layout size={20} /> },
    { id: 'styling', label: t('skills.categories.styling'), icon: <Palette size={20} /> },
    { id: 'tools', label: t('skills.categories.tools'), icon: <Tool size={20} /> },
    { id: 'design', label: t('skills.categories.design'), icon: <Palette size={20} /> },
  ];
        ...
        >
          {filteredSkills.map((skill, index) => (
            ...
            >
              ...
              <h3 className={`${isRTL ? 'font-arabic' : ''} text-center text-gray-800 dark:text-gray-200 font-medium`}>
                {skill.name}
              </h3>
            </motion.div>
          ))}
