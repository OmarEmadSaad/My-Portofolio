        ...
        >
          {projects.map((project) => (
            ...
            >
              ...
              <div className="p-6">
                <h3
                  className={`${isRTL ? "font-arabic" : ""} text-xl font-semibold text-gray-900 dark:text-white mb-2`}
                >
                  {project.title}
                </h3>
                <p
                  className={`${isRTL ? "font-arabic" : ""} text-gray-700 dark:text-gray-300 mb-4 min-h-[80px]`}
                >
                ...
                <div className="flex gap-3 mt-4">
                  {project.downloadNow ? (
                    // زرار Download Now للـ APK
                    <motion.a
                      href={project.downloadNow}
                      download="GoodNews.apk" // ← يحدد اسم الملف للتحميل
                    ...
                    >
                      <Download size={16} />
                      {t("projects.downloadNow")}
                    </motion.a>
                  ) : (
                    // زرار View Live للـ web demos
                    <motion.a
